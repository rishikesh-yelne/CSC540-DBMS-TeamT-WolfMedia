...
public class SetupQuery {
    ...
    public static final String CREATE_TABLE_PODCAST = "CREATE TABLE IF NOT EXISTS Podcast (podcast_id int NOT NULL AUTO_INCREMENT,user_id int, pname varchar(64) NOT NULL,planguage varchar(30) NOT NULL,country varchar(64) NOT NULL,PRIMARY KEY(podcast_id), FOREIGN KEY (`user_id`) REFERENCES `Podcast_Host` (`user_id`) ON DELETE NULL);";
