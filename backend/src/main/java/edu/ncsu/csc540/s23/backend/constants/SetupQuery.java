...
public class SetupQuery {
    ...
    public static final String CREATE_TABLE_PODCAST = "CREATE TABLE IF NOT EXISTS Podcast (podcast_id int NOT NULL AUTO_INCREMENT,pname varchar(64) NOT NULL,planguage varchar(30) NOT NULL,country varchar(64) NOT NULL, flat_fee DECIMAL(10,2) NOT NULL,PRIMARY KEY(podcast_id));";
    ...
    public static final String INSERT_PODCAST = "INSERT INTO Podcast (podcast_id, pname, planguage, country, flat_fee) VALUES(5001, 'Mind Over Matter: Exploring the Power of the Human Mind', 'English', 'United States', 10)";
