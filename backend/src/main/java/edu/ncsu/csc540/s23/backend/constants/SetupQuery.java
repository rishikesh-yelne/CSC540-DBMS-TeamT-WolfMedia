...
public class SetupQuery {
    ...
    public static final String CREATE_TABLE_PODCAST = "CREATE TABLE IF NOT EXISTS Podcast (podcast_id int NOT NULL AUTO_INCREMENT,user_id int, pname varchar(64) NOT NULL,planguage varchar(30) NOT NULL,country varchar(64) NOT NULL,PRIMARY KEY(podcast_id), FOREIGN KEY (`user_id`) REFERENCES `Podcast_Host` (`user_id`) ON DELETE CASCADE);";
    ...
    public static final String INSERT_PODCAST = "INSERT INTO Podcast (podcast_id, user_id, pname, planguage, country) VALUES(5001, 6001, 'Mind Over Matter: Exploring the Power of the Human Mind', 'English', 'United States')";
