...
public class SetupQuery {
    ...
    // endregion
    // region Insert Data
    public static String INSERT_USER_1 = "INSERT INTO User (user_id, first_name, last_name, email_id, phone_num, reg_date) VALUES(8001, 'Alex', 'A', 'alex.a@ncsu.edu', '+1(919)000-0001', '2023-04-02')";
    public static String INSERT_USER_2 = "INSERT INTO User (user_id, first_name, last_name, email_id, phone_num, reg_date) VALUES(8002, 'John', 'J', 'john.j@ncsu.edu', '+1(919)000-0002', '2023-04-03')";
    public static String INSERT_ARTIST_USER_1 = "INSERT INTO User (user_id, first_name, last_name, email_id, phone_num, reg_date) VALUES(2001, 'Forest', 'F', 'forest.f@ncsu.edu', '+1(919)000-1001', '2023-01-01')";
    public static String INSERT_ARTIST_USER_2 = "INSERT INTO User (user_id, first_name, last_name, email_id, phone_num, reg_date) VALUES(2002, 'Rain', 'R', 'rain.r@ncsu.edu', '+1(919)000-1002', '2023-01-02')";
    public static String INSERT_PODCAST_HOST_USER_1 = "INSERT INTO User (user_id, first_name, last_name, email_id, phone_num, reg_date) VALUES(6001, 'Matthew', 'Wilson', 'matthew.wilson@ncsu.edu', '+1(919)000-2001', '2023-01-03')";
    public static String INSERT_ALBUM_1 = "INSERT INTO Album (album_id, album_name, release_year, edition) VALUES(4001, 'Electric Oasis', 2023, 'Special')";
    public static String INSERT_ALBUM_2 = "INSERT INTO Album (album_id, album_name, release_year, edition) VALUES(4002, 'Lost in the Echoes', 2023, 'Limited')";
    public static String INSERT_RECORD_LABEL_1 = "INSERT INTO Record_Label (rlabel_id, rlabel_name) VALUES(3001, 'Elevate Records')";
    public static String INSERT_RECORD_LABEL_2 = "INSERT INTO Record_Label (rlabel_id, rlabel_name) VALUES(3002, 'Melodic Avenue Music')";
    public static String INSERT_GENRE_1 = "INSERT INTO Genre (genre_id, name, gtype) VALUES(1, 'Country Music', 'Happy')";
    public static String INSERT_GENRE_2 = "INSERT INTO Genre (genre_id, name, gtype) VALUES(2, 'Instrumental', 'Classical')";
    public static String INSERT_ARTIST_1 = "INSERT INTO Artist (user_id, rlabel_id, primary_genre_id, status, type, artist_country) VALUES(2001, 3001, 1, 'Active', 'Band', 'United States')";
    public static String INSERT_ARTIST_2 = "INSERT INTO Artist (user_id, rlabel_id, primary_genre_id, status, type, artist_country) VALUES(2002, 3002, 2, 'Active', 'Composer', 'United States')";
    public static String INSERT_SONG_1 = "INSERT INTO Song (song_id,  album_id, title, duration, track_no, release_date, release_country, language, royalty_rate) VALUES(1001, 4001, 'Electric Dreamscape', '04:11:00', 1, '2023-03-27', 'United States', 'English', 0.1)";
    public static String INSERT_SONG_2 = "INSERT INTO Song (song_id,  album_id, title, duration, track_no, release_date, release_country, language, royalty_rate) VALUES(1002, 4001, 'Midnight Mirage', '03:58:00', 2, '2023-03-31', 'United States', 'English', 0.1)";
    public static String INSERT_SONG_3 = "INSERT INTO Song (song_id,  album_id, title, duration, track_no, release_date, release_country, language, royalty_rate) VALUES(1003, 4002, 'Echoes of You', '04:05:00', 1, '2023-04-01', 'United States', 'English', 0.1)";
    public static String INSERT_SONG_4 = "INSERT INTO Song (song_id,  album_id, title, duration, track_no, release_date, release_country, language, royalty_rate) VALUES(1004, 4002, 'Rainy Nights', '03:25:00', 2, '2023-04-02', 'United States', 'English', 0.1)";
    public static String INSERT_PODCAST_HOST_1 = "INSERT INTO Podcast_Host (user_id, city) VALUES(6001, 'Raleigh')";
    public static String INSERT_PODCAST = "INSERT INTO Podcast (podcast_id, pname, planguage, country) VALUES(5001, 'Mind Over Matter: Exploring the Power of the Human Mind', 'English', 'United States')";
    public static String INSERT_PODCAST_EPISODE_1 = "INSERT INTO Podcast_Episode (pepi_id, podcast_id, epi_title, prelease_date, pduration, adv_count, episode_no) VALUES(7001, 5001, 'The Science of Mindfulness', '2023-04-02', '55:12:00', 0, 1)";
    public static String INSERT_PODCAST_EPISODE_2 = "INSERT INTO Podcast_Episode (pepi_id, podcast_id, epi_title, prelease_date, pduration, adv_count, episode_no) VALUES(7002, 5001, 'Unlocking Your Potential', '2023-04-03', '41:52:00', 0, 2)";
    // endregion
}
